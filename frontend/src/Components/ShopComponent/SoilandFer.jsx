    ...
    <>
        <div className="container" id='productcontainer'>
                    <div className="pagetittle mt-5">
                        <h3 className='text-center'>Soil & Fertilizer</h3>
                    </div>
                    <div className="row" id='productrow'>
                            ...
                            <div className="accordion-item mt-4">
                                ...
                                <div id="panelsStayOpen-collapseOne" className="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                                   <div className="accordion-body">
                                        ...
                                        <a href="/soil">Soil</a>
                                        <hr />
                                        <a href="/inorganic">Inorganic Fertilizer</a>
                                        <hr />
                                        <a href="/organic">Organic Fertilizers</a>
                                        <hr />
                        ...
                        {
                           dataProduct.filter(a =>a.category === "Soil and Fertilizers").map((value,index)=>{
                                return(
